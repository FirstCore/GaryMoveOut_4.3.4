...
(@CGUID+2, 51126, 726, 1, 1, 1975.323, 179.8021, -4.407125, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+3, 51126, 726, 1, 1, 1970.083, 172.7257, -4.407125, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+4, 51126, 726, 1, 1, 1966.523, 183.7569, -4.407125, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+5, 51126, 726, 1, 1, 1985.748, 162.4809, 0.5268366, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: Wildhammer Stronghold) (possible waypoints or random movement)
...
(@CGUID+8, 51126, 726, 1, 1, 1956.556, 171.5816, -4.407125, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+9, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
...
(@CGUID+12, 51126, 726, 1, 1, 1932.455, 205.7616, -17.01718, 2.861426, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: 0) (possible waypoints or random movement)
(@CGUID+13, 51126, 726, 1, 1, 1940.066, 236.6979, -14.6197, 4.660029, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: 0) (possible waypoints or random movement)
(@CGUID+14, 51126, 726, 1, 1, 1926.195, 228.125, -17.53668, 3.141593, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: 0) (possible waypoints or random movement)
(@CGUID+15, 51126, 726, 1, 1, 1925.845, 218.7499, -17.02013, 2.81808, 7200, 0, 1), -- Wildhammer Gryphon Hatchling (Area: 0) (possible waypoints or random movement)
...
(@CGUID+18, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+19, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
...
(@CGUID+25, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+26, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
...
(@CGUID+31, 51128, 726, 1, 1, 1956.732, 404.1992, -9.047995, 0.5061455, 7200, 0, 1), -- Wildhammer Guard (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+32, 51128, 726, 1, 1, 1944.977, 416.2066, -10.00108, 6.056293, 7200, 0, 0), -- Wildhammer Guard (Area: Wildhammer Stronghold)
(@CGUID+33, 51128, 726, 1, 1, 1946.829, 407.9122, -9.483633, 4.991826, 7200, 0, 1), -- Wildhammer Guard (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+34, 51127, 726, 1, 1, 1877.621, 5.201612, 38.05733, 1.5474, 7200, 0, 0), -- Wildhammer Gryphon (Area: 0)
(@CGUID+35, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+36, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+37, 52977, 726, 1, 1, 1818.918, 156.9167, 1.889777, 1.815142, 7200, 0, 0), -- World Trigger (Friendly + Invis Stalker) (Area: 0)
(@CGUID+38, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
...
(@CGUID+46, 51130, 726, 1, 1, 1759.554, 225.2465, -13.94948, 1.797689, 7200, 0, 1), -- Dragonmaw Worker (Area: 0) (possible waypoints or random movement)
...
(@CGUID+49, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+50, 51130, 726, 1, 1, 1767.208, 401.441, -15.22443, 2.181662, 7200, 0, 0), -- Dragonmaw Worker (Area: 0)
(@CGUID+51, 51127, 726, 1, 1, 2087.113, 168.289, 104.5053, 3.006558, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+52, 51127, 726, 1, 1, 2096.856, 302.8097, 98.42361, 3.006042, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
...
(@CGUID+60, 42615, 726, 1, 1, 1750.323, 433.0492, -7.96629, 2.533708, 7200, 0, 1), -- Twin Peaks Boar (Area: 0) (possible waypoints or random movement)
...
(@CGUID+63, 51127, 726, 1, 1, 2194.064, 350.5839, 66.43506, 4.394663, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
...
(@CGUID+66, 42615, 726, 1, 1, 1730.788, 423.4054, -7.867835, 4.653298, 7200, 0, 1), -- Twin Peaks Boar (Area: 0) (possible waypoints or random movement)
(@CGUID+67, 42615, 726, 1, 1, 1742.042, 450.5851, -7.749567, 3.368485, 7200, 0, 0), -- Twin Peaks Boar (Area: 0)
(@CGUID+68, 51130, 726, 1, 1, 1740.724, 453.6866, -7.540817, 6.188134, 7200, 0, 1), -- Dragonmaw Worker (Area: 0) (possible waypoints or random movement)
(@CGUID+69, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Dragonmaw Stronghold) (possible waypoints or random movement)
(@CGUID+70, 51127, 726, 1, 1, 1930.316, 211.658, -16.99481, 1.32645, 7200, 0, 1), -- Wildhammer Gryphon (Area: Dragonmaw Stronghold) (possible waypoints or random movement)
(@CGUID+71, 51127, 726, 1, 1, 2018.228, 140.5488, 26.03765, 4.079322, 7200, 0, 1), -- Wildhammer Gryphon (Area: Dragonmaw Stronghold) (possible waypoints or random movement)
...
(@CGUID+75, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+76, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+77, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
...
(@CGUID+83, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+84, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+85, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
...
(@CGUID+89, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: 0) (possible waypoints or random movement)
(@CGUID+90, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+91, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Stronghold) (possible waypoints or random movement)
(@CGUID+92, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+93, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+94, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+95, 51127, 726, 1, 1, 1890.335, -17.76215, 45.33773, 1.117011, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+96, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1), -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
(@CGUID+97, 51127, 726, 1, 1, 1878.674, -17.76215, 45.33773, 1.204277, 7200, 0, 1); -- Wildhammer Gryphon (Area: Wildhammer Flag Room) (possible waypoints or random movement)
