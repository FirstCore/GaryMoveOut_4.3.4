...
(18,44427,67766,0,0,9,0,14212,0,0,0,0,0,"","Npc_spellclick_spells - 'Quest Sacrifices' Must Be Accepted"),
(18,44427,67766,0,0,8,0,14212,0,0,1,0,0,"","Npc_spellclick_spells - 'Quest Sacrifices' Must NOT Be Completed");
...
INSERT INTO conditions VALUES
(13,7,67063,0,0,31,0,3,35229,0,0,0,0,"","Must focus damage on Bloodfang Stalker");

UPDATE quest_template SET flags=0, specialflags=0, RequiredNpcOrGo1=35582, endtext="Speak to Tobias Mistmantle at the Light's Dawn Cathedral in Gilneas City.", completedtext='' WHERE id=14212;
