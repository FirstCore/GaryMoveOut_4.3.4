...
#ifndef ARKCORE_SMARTSCRIPT_H
#define ARKCORE_SMARTSCRIPT_H
...
class SmartScript
{
    public:
        ...
        GameObject* FindGameObjectNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            CellCoord p(Arkcore::ComputeCellCoord(searchObject->GetPositionX(), searchObject->GetPositionY()));
            Cell cell(p);
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            Arkcore::CreatureSearcher<Arkcore::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
