...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_MAX_JUSTICE_POINTS] = ConfigMgr::GetIntDefault("Currency.MaxJusticePoints", 4000);
    if (int32(m_int_configs[CONFIG_MAX_JUSTICE_POINTS]) < 0)
    {
        sLog->outError(LOG_FILTER_SERVER_LOADING, "Currency.MaxJusticePoints (%i) can't be negative. Set to default 4000.", m_int_configs[CONFIG_MAX_JUSTICE_POINTS]);
        m_int_configs[CONFIG_MAX_JUSTICE_POINTS] = 4000;
    }
    m_int_configs[CONFIG_MAX_JUSTICE_POINTS] *= 100; //precision mod
    ...
    m_bool_configs[CONFIG_DISABLE_FATIGUE] = ConfigMgr::GetBoolDefault("DisableFatigue", true);
    ...
    m_int_configs[CONFIG_TOL_BARAD_PLR_MIN_LVL] = ConfigMgr::GetIntDefault("TolBarad.PlayerMinLvl", 80);
...
void World::ShutdownMsg(bool show, Player* player)
{
    ...
    if (show ||
        (m_ShutdownTimer < 10) ||                                                       // < 10 sec ; every 1  sec
