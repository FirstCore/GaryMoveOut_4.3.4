...
void GameEventMgr::RunSmartAIScripts(uint16 event_id, bool activate)
{
    ...
    {
        ARKCORE_READ_GUARD(HashMapHolder<Creature>::LockType, *HashMapHolder<Creature>::GetLock());
    ...
    {
        ARKCORE_READ_GUARD(HashMapHolder<GameObject>::LockType, *HashMapHolder<GameObject>::GetLock());
