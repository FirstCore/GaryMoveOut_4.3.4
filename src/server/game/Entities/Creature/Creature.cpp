...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius >0)
    {
        ...
        Arkcore::CreatureLastSearcher<Arkcore::NearestAssistCreatureInCreatureRangeCheck> searcher(this, creature, u_check);
...
void Creature::CallForHelp(float radius)
{
    ...
    Arkcore::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), radius);
