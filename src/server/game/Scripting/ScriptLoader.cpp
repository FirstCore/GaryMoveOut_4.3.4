...
void AddSC_westfall();
void AddSC_wetlands();
void AddSC_instance_blackrock_caverns();        // Caverne Rochenoire
...
void AddSC_boss_commander_ulthok();                // Trone des marées
...
void AddSC_vortex_pinnacle();               //The vortex pinnacle
...
void AddSC_instance_lost_city_of_the_tolvir();  //the lost city of the tol vir
...
void AddSC_deepholm();
void AddSC_kezan();
void AddSC_instance_the_stonecore(); //TheStonecore
...
void AddCommandScripts()
{
    ...
    AddSC_signal_commandscript();
    AddSC_achat_commandscript();
}
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_instance_blackrock_caverns();        // Caverne Rochenoire
    ...
    AddSC_boss_commander_ulthok();            // Trone des marrée
...
void AddKalimdorScripts()
{
    ...
    AddSC_ungoro_crater();
    AddSC_winterspring();
    AddSC_vortex_pinnacle();               //The vortex pinnacle
...
void AddMaelstromScripts()
{
    ...
    AddSC_deepholm();
    AddSC_kezan();
    AddSC_instance_the_stonecore(); //TheStonecore
    AddSC_boss_azil(); 
    AddSC_boss_corborus();
    AddSC_boss_ozruk();
    AddSC_boss_slabhide();
