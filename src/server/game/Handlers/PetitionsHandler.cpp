...
void WorldSession::HandlePetitionQueryOpcode(WorldPacket & recvData)
{
    ...
    uint32 guildguid;
    uint64 petitionguid;
    recvData >> guildguid;                                 // in Arkcore always same as GUID_LOPART(petitionguid)
    recvData >> petitionguid;                              // petition guid
...
void WorldSession::SendPetitionQueryOpcode(uint64 petitionguid)
{
    ...
    data << uint32(GUID_LOPART(petitionguid));              // guild/team guid (in Arkcore always same as GUID_LOPART(petition guid)
