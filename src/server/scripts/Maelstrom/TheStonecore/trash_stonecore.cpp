...
class mob_unbound_earth_rager : public CreatureScript
{
 public:
      ...
      {
        mob_unbound_earth_ragerAI(Creature * creature) : ScriptedAI(creature) {}
...
{
        return new mob_unbound_earth_ragerAI(creature);
}
...
class mob_stonecore_rift_conjurer : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_rift_conjurerAI(Creature * creature) : ScriptedAI(creature) {}
...
class mob_stonecore_berserker : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_berserkerAI(Creature * creature) : ScriptedAI(creature) {}
...
CreatureAI* GetAI(Creature* creature) const
{
        return new mob_stonecore_berserkerAI(creature);
}
...
class mob_stonecore_bruiser : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_bruiserAI(Creature * creature) : ScriptedAI(creature) {}
...
CreatureAI* GetAI(Creature* creature) const
{
        return new mob_stonecore_bruiserAI(creature);
}
...
class mob_stonecore_flayer : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_flayerAI(Creature * creature) : ScriptedAI(creature) {}
...
CreatureAI* GetAI(Creature* creature) const
{
        return new mob_stonecore_flayerAI(creature);
}
...
class mob_stonecore_warbringer : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_warbringerAI(Creature * creature) : ScriptedAI(creature) {}
...
CreatureAI* GetAI(Creature* creature) const
{
        return new mob_stonecore_warbringerAI(creature);
}
...
class mob_stonecore_earthshaper : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_earthshaperAI(Creature * creature) : ScriptedAI(creature) {}
...
class mob_stonecore_magmalord : public CreatureScript
{
 public:
      ...
      {
        mob_stonecore_magmalordAI(Creature * creature) : ScriptedAI(creature) {}
...
CreatureAI* GetAI(Creature* creature) const
{
        return new mob_stonecore_magmalordAI(creature);
}
