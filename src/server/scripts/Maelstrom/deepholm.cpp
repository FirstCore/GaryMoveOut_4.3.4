...
#define CREW_SAY_1 "Ils ont empoisonné nos vivres… Ils avaient des agents chez nous depuis le début…"
#define CREW_SAY_2 "Tout le monde s'est mis à tomber, comme des mouches… Tous ceux qui ont goûté aux rations."
#define CREW_SAY_3 "Ils nous ont manipulés pour nous faire attaquer le bateau de la Horde… mais pourquoi ?"
#define CREW_SAY_4 "Je les ai entendus prier leurs dieux du mal quand tout est devenu noir… C'est le Marteau du crépuscule qui est responsable !"
#define CREW_SAY_5 "Vipère du crépuscule ! C'est vous qui nous avez fait ça !"
