...
public:
    ...
    static bool HandleGPSCommand(ChatHandler* handler, char const* args)
    {
        ...
        CellCoord cellCoord = Arkcore::ComputeCellCoord(object->GetPositionX(), object->GetPositionY());
        Cell cell(cellCoord);
        ...
        GridCoord gridCoord = Arkcore::ComputeGridCoord(object->GetPositionX(), object->GetPositionY());
    ...
    static bool HandleRespawnCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        Arkcore::WorldObjectWorker<Arkcore::RespawnDo> worker(player, u_do);
