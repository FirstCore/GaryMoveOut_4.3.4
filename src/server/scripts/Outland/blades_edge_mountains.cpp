        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                Arkcore::AllWorldObjectsInRange objects(me, searchDistance);
                Arkcore::WorldObjectListSearcher<Arkcore::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
