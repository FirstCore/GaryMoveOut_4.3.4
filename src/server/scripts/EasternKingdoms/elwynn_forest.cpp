...
public:
    npc_henze_faulk() :
            CreatureScript("npc_henze_faulk") {
    }
...
public:
    npc_stormwind_infantry() :
            CreatureScript("npc_stormwind_infantry") {
    }
    ...
    struct npc_stormwind_infantryAI: public ScriptedAI {
        npc_stormwind_infantryAI(Creature *c) :
                ScriptedAI(c) {
        }
        ...
        void SetData(uint32 type, uint32 data) {
            if (Creature* Paxton = me->FindNearestCreature(NPC_BROTHER_PAXTON, 20, true)) {
                ...
                if (Continue == true) {
                    DoScriptText(
                            RAND(SAY_INFANTRY_COMBAT_1, SAY_INFANTRY_COMBAT_2,
                                    SAY_INFANTRY_COMBAT_3,
                                    SAY_INFANTRY_COMBAT_4), me);
                    Paxton->SetOrientation(me->GetAngle(Paxton));
                    Paxton->SendMovementFlagUpdate();
                    DoScriptText(
                            RAND(SAY_PAXTON_NORMAL_1, SAY_PAXTON_NORMAL_2,
                                    SAY_PAXTON_NORMAL_3, SAY_PAXTON_NORMAL_4,
                                    SAY_PAXTON_NORMAL_5), Paxton);
                    switch (type) {
                    case 1:
        ...
        void DamageDealt(Unit* target, uint32& damage,
            ...
            if (me->isAlive())
                if (!me->isInCombat()) {
                    if (me->GetDistance2d(me->GetHomePosition().GetPositionX(),
                            me->GetHomePosition().GetPositionY()) <= 1.0f)
                    ...
                    if (uiSayNormalTimer <= diff) {
                        DoScriptText(
                                RAND(SAY_INFANTRY_NORMAL_1,
                                        SAY_INFANTRY_NORMAL_2,
                                        SAY_INFANTRY_NORMAL_3,
                                        SAY_INFANTRY_NORMAL_4,
                                        SAY_INFANTRY_NORMAL_5), me);
                        uiSayNormalTimer = urand(3000, 90000);
                    } else
                        uiSayNormalTimer -= diff;

                    if (me->GetHomePosition().GetPositionX()
                            != me->GetPositionX()
                ...
                if (uiSayCombatTimer <= diff) {
                    if (Creature* Paxton = me->FindNearestCreature(NPC_STORMWIND_INFANTRY, 20, true)) {
                        ...
                        if (Mob != 0)
                            ...
                            DoScriptText(
                                    RAND(SAY_INFANTRY_COMBAT_1,
                                            SAY_INFANTRY_COMBAT_2,
                                            SAY_INFANTRY_COMBAT_3,
                                            SAY_INFANTRY_COMBAT_4), me);
                    }
                    uiSayCombatTimer = urand(30000, 60000);
...
public:
    npc_brother_paxton() :
            CreatureScript("npc_brother_paxton") {
    }
    ...
    struct npc_brother_paxtonAI: public ScriptedAI {
        npc_brother_paxtonAI(Creature *c) :
                ScriptedAI(c) {
...
public:
    npc_blackrock_battle_worg() :
            CreatureScript("npc_blackrock_battle_worg") {
    }
    ...
    struct npc_blackrock_battle_worgAI: public ScriptedAI {
        npc_blackrock_battle_worgAI(Creature *c) :
                ScriptedAI(c) {
        }
...
public:
    npc_blackrock_spy() :
            CreatureScript("npc_blackrock_spy") {
    }
    ...
    struct npc_blackrock_spyAI: public ScriptedAI {
        npc_blackrock_spyAI(Creature *c) :
                ScriptedAI(c) {
            CastSpying();
        }
        ...
        void GetCreature(float X, float Y) {
            if (me->GetHomePosition().GetPositionX() == X, me->GetHomePosition().GetPositionY()
                    == Y)
        ...
        void Spyglass(float X1, float Y1, float X2, float Y2, float X3,
                float Y3, float X4, float Y4, float X5, float Y5, float X6,
                float Y6, float X7, float Y7, float X8, float Y8, float X9,
                float Y9) {
            if (me->GetHomePosition().GetPositionX() != X1, me->GetHomePosition().GetPositionY()
                    != Y1)
                if (me->GetHomePosition().GetPositionX() != X2, me->GetHomePosition().GetPositionY()
                        != Y2)
                    if (me->GetHomePosition().GetPositionX() != X3, me->GetHomePosition().GetPositionY()
                            != Y3)
                        if (me->GetHomePosition().GetPositionX() != X4, me->GetHomePosition().GetPositionY()
                                != Y4)
                            if (me->GetHomePosition().GetPositionX() != X5, me->GetHomePosition().GetPositionY()
                                    != Y5)
                                if (me->GetHomePosition().GetPositionX() != X6, me->GetHomePosition().GetPositionY()
                                        != Y6)
                                    if (me->GetHomePosition().GetPositionX()
                                            != X7, me->GetHomePosition().GetPositionY()
                                            != Y7)
                                        if (me->GetHomePosition().GetPositionX()
                                                != X8, me->GetHomePosition().GetPositionY()
                                                != Y8)
                                            if (me->GetHomePosition().GetPositionX()
                                                    != X9, me->GetHomePosition().GetPositionY()
                                                    != Y9)
                                                if (me->GetHomePosition().GetPositionX()
                                                        == me->GetPositionX(), me->GetHomePosition().GetPositionY()
                                                        == me->GetPositionY())
                                                    if (!me->isInCombat()
                                                            && !me->HasAura(
                                                                    SPELL_SPYGLASS))
        ...
        void EnterCombat(Unit * who) {
            DoScriptText(
                    RAND(SAY_BLACKROCK_COMBAT_1, SAY_BLACKROCK_COMBAT_2,
                            SAY_BLACKROCK_COMBAT_3, SAY_BLACKROCK_COMBAT_4,
                            SAY_BLACKROCK_COMBAT_5), me);
        }
...
public:
    npc_blackrock_invader() :
            CreatureScript("npc_blackrock_invader") {
    }
    ...
    struct npc_blackrock_invaderAI: public ScriptedAI {
        npc_blackrock_invaderAI(Creature *c) :
                ScriptedAI(c) {
        }
...
public:
    npc_goblin_assassin() :
            CreatureScript("npc_goblin_assassin") {
    }
    ...
    struct npc_goblin_assassinAI: public ScriptedAI {
        npc_goblin_assassinAI(Creature *c) :
                ScriptedAI(c) {
            if (!me->isInCombat() && !me->HasAura(SPELL_SPYING))
        ...
        void EnterCombat(Unit * who) {
            DoScriptText(RAND(SAY_ASSASSIN_COMBAT_1, SAY_ASSASSIN_COMBAT_2),
                    me);
        }
...
enum {
    SPELL_RENEWEDLIFE = 93097, NPC_INJURED_SOLDIER_DUMMY = 50378
};

class npc_injured_soldier: public CreatureScript {
public:
    npc_injured_soldier() :
            CreatureScript("npc_injured_soldier") {
    }

    struct npc_injured_soldierAI: public ScriptedAI {
        npc_injured_soldierAI(Creature *pCreature) :
            ...
            if (Player* pOwner = me->GetPlayer(*me, me->GetCreatorGUID())) {
                if (RunTimer <= diff) {
                    ...
                    case 0: {
                        ...
                        //I'm really lazy ;)
                        case 0:
                            me->MonsterSay("Que Dieux vous bénisse, héro !", 0, NULL);
                            break;
                        case 1:
                            me->MonsterSay("Je ne crains aucun mal !", 0, NULL);
                            break;
                        case 2:
                            me->MonsterSay("Merci la Lumière !", 0, NULL);
                            break;
                        case 3:
                            me->MonsterSay("Vous êtes $p ! Le héros dont tout le monde parle ! Merci !", 0, pOwner->GetGUID());
                            break;
                        default:
                            break;
                        }
