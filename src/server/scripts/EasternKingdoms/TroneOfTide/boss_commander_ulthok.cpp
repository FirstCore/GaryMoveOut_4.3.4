...
#define SAY_AGGRO "Là où un seul tombe, plusieurs prennent sa place..."
#define SAY_DIED "Ils ne meurent pas."
...
class spell_commander_ulthok_fissure : public SpellScriptLoader
{
    public:
        ...
        class spell_commander_ulthok_fissure_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_commander_ulthok_fissure_SpellScript::CorrectRange, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_commander_ulthok_fissure_SpellScript::CorrectRange, EFFECT_1, TARGET_UNIT_SRC_AREA_ENEMY);
