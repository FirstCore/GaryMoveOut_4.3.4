...
#define GOSSIP_READY "Nous sommes prêts!"

#define SAY_1 "La purification de ces eaux va sûrement provoquer les serviteurs des immondices. Prenez garde !"
#define SAY_2 "Patience, mes invités. Les eaux sont presque purifiées."
#define SAY_3 "La bête est revenue ! Il ne faut pas qu'elle pollue mes eaux !"
#define SAY_DEATH "Je me sens... fatigué..."
#define SAY_CLEANSED "Mes eaux sont purifiées ! Buvez et goûtez leur pouvoir !"
