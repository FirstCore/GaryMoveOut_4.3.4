...
{
	mob_envahisseur_nazjarAI(Creature *pCreature) : ScriptedAI(pCreature) {}
 ...
 ********************/
 ...
 {
 mob_soignesprit_nazjarAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_sorciere_des_tempetes_nazjarAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_sentinelle_nazjarAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_corruption_instableAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_factionnaire_corrompuAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_aquamage_gloubelinAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_chasseur_gloubelinAI(Creature *pCreature) : ScriptedAI(pCreature) {}
...
{
mob_gardien_sans_visageAI(Creature *pCreature) : ScriptedAI(pCreature) {}
