...
public:
    ...
    struct boss_karsh_steelbenderAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            me->MonsterYell("Des corps pour tester mes nouvelles armes !", LANG_UNIVERSAL, NULL);
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            {    // Summon Adds
                ...
                me->MonsterYell("Attention, ça brûle !", LANG_UNIVERSAL, NULL);
        ...
        {
            DespawnCreatures(NPC_BOUND_FLAMES);
            me->MonsterYell("À peine une impureté dans l'alliage…", LANG_UNIVERSAL, NULL);
        }
