...
public:
    ...
    struct boss_corla_herald_of_twilightAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            me->MonsterYell("HÉRÉTIQUES ! Vous allez payer pour cette interruption !", LANG_UNIVERSAL, NULL);
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            me->MonsterYell("Il n'y a qu'une voie vers l'illumination : LA MORT !", LANG_UNIVERSAL, NULL);
        }
