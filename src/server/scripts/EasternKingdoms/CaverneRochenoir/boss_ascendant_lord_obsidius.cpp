...
public:
    ...
    struct boss_ascendant_lord_obsidiusAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/) 
        {
            ...
            me->MonsterYell("Vous cherchez des réponses ! Alors voilà ma réponse à votre existence !", LANG_UNIVERSAL, NULL);
        }
        ...
        void UpdateAI(const uint32 diff)
        {
            ...
            if ((me->HealthBelowPct(69) && Phase == 0) || (me->HealthBelowPct(34) && Phase == 1))
            {
                ...
                me->MonsterYell("Vous n'avez pas votre place dans le monde du maître.", LANG_UNIVERSAL, NULL);
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            me->MonsterYell("Personne ne peut me détruire… Juste me… retar… der…", LANG_UNIVERSAL, NULL);
        }
    };
};
