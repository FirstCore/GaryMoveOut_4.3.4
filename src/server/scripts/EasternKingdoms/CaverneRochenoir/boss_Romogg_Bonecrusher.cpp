...
public:
    ...
    struct boss_romogg_bonecrusherAI : public ScriptedAI
    {
        ...
        {
            me->MonsterYell("Voilà pour vous ! Rien !", LANG_UNIVERSAL, NULL);
...
*/
                ...
                if(castSkullCracker)
                {
                    me->MonsterYell(" Pas bouger ! Rom'ogg exploser vos têtes !", LANG_UNIVERSAL, NULL);
        ...
        {
            DespawnCreatures(NPC_ANGERED_EARTH);
            me->MonsterYell("Patron Cho'gall il va pas être content !", LANG_UNIVERSAL, NULL);
