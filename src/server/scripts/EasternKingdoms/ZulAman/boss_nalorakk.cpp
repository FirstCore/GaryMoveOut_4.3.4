        ...
        struct boss_nalorakkAI : public ScriptedAI
        {
            ...
            void SendAttacker(Unit* target)
            {
...

                {
                    ...
                    Arkcore::AllFriendlyCreaturesInGrid check(me);
                    Arkcore::CreatureListSearcher<Arkcore::AllFriendlyCreaturesInGrid> searcher(me, templist, check);

                    TypeContainerVisitor<Arkcore::CreatureListSearcher<Arkcore::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
