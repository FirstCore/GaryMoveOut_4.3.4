        ...
        class spell_pursue_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                else
                {
                    ...
                    _target = Arkcore::Containers::SelectRandomContainerElement(targets);
                ...
                if (targets.HasTraj())
                    if (Vehicle* vehicle = GetCaster()->GetVehicleKit())
                        if (Unit* passenger = vehicle->GetPassenger(damage - 1))
                        {
                            ...
                            Arkcore::WorldObjectSpellAreaTargetCheck check(99, GetExplTargetDest(), GetCaster(), GetCaster(), GetSpellInfo(), TARGET_CHECK_DEFAULT, NULL);
                            Arkcore::WorldObjectListSearcher<Arkcore::WorldObjectSpellAreaTargetCheck> searcher(GetCaster(), targetList, check);
