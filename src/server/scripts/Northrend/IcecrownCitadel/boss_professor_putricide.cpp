    ...
    public:
        ...
        class spell_putricide_unbound_plague_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                targets.remove_if(Arkcore::UnitAuraCheck(true, sSpellMgr->GetSpellIdForDifficulty(SPELL_UNBOUND_PLAGUE, GetCaster())));
                Arkcore::Containers::RandomResizeList(targets, 1);
            }
