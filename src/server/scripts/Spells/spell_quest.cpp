    ...
    public:
        ...
        class spell_q11010_q11102_q11023_choose_loc_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                Arkcore::AnyPlayerInObjectRangeCheck checker(caster, 765.0f);
                Arkcore::PlayerListSearcher<Arkcore::AnyPlayerInObjectRangeCheck> searcher(caster, playerList, checker);
