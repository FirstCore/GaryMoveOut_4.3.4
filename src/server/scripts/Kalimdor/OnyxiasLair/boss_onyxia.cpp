            ...
            if (Phase == PHASE_START || Phase == PHASE_END)
            {
                ...
                else
                {
                    if (BellowingRoarTimer <= Diff)
                    {
                        ...
                        Arkcore::GameObjectInRangeCheck check(me->GetPositionX(), me->GetPositionY(), me->GetPositionZ(), 15);
                        Arkcore::GameObjectLastSearcher<Arkcore::GameObjectInRangeCheck> searcher(me, Floor, check);
