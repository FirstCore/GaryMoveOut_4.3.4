...
#define SAY_AGGRO "Vous piétinez le sacro-saint ! Les mortels n'ont pas leur place dans les nuages."
#define SAY_RANDOM "BACK to the earth with you!"
#define SAY_RANDOM_1 "BACK to the earth with you!"
#define SAY_CAST_FIELD "Al'Akir, ton serviteur implore ton aide !"
#define SAY_DEATH "Que les vents m'emportent !"
